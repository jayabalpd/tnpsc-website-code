...
include "config.php";
?>
<title>GK Questions PDF Files</title>
<section id="content">
    <br><br>
...
<div class="col-lg-4 col-md-4 col-sm-4">
	...
	if (isset($_GET['pageno'])) {
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM upload_file";
        $result = mysqli_query($conn,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        $sql = "SELECT * FROM upload_file LIMIT $offset, $no_of_records_per_page";
  ...
  <div align="center">
   <ul class="pagination" >
        ...
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "pdf.php?pageno=".($pageno - 1); } ?>">Previous</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "pdf.php?pageno=".($pageno + 1); } ?>">Next</a>
        </li>
...
echo "<div align=right class=banchor><a  style=cursor: pointer href=pdflesson/$subjectname/".$sdisplay['subject_id'].">Read More>></a></div>";
...
echo "<li class=cat-item><a  style=cursor: pointer href=pdffiles/$suname/$lesname/$tname/".$row1['topic_id'].">".$row['lesson_name']."</a></li>";
...
echo "<li class=cat-item><a  style=cursor: pointer href=pdftopic/$subname/$lessonname/".$row['lesson_id'].">".$row['lesson_name']."</a></li>";
